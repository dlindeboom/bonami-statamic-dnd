...
<footer class="bg-colors-cool-gray-800 pt-6 mt-8 text-colors-cool-gray-500 shadow-lg">
    <div class="container mx-auto flex py-4 lg:flex-row flex-col justify-between px-4 lg:space-x-6">
        ...
        <ul class="lg:w-1/4 w-full">
            <li class="text-colors-cool-gray-100 font-bold pb-2">Upcoming events</li>
            <li class="bg-gradient-to-b h-0.5 from-colors-cool-gray-900 from-50% to-colors-cool-gray-700"></li>
        ...
        <ul class="lg:w-1/4 w-full">
            <li class="text-colors-cool-gray-100 font-bold pb-2">Practical information</li>
            <li class="bg-gradient-to-b h-0.5 from-colors-cool-gray-900 from-50% to-colors-cool-gray-700"></li>
        ...
        <ul class="lg:w-1/4 w-full">
            <li class="text-colors-cool-gray-100 font-bold pb-2">Social media</li>
            <li class="bg-gradient-to-b h-0.5 from-colors-cool-gray-900 from-50% to-colors-cool-gray-700"></li>
